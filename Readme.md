# 💫 About Me:
Final-year **Information Technology** student at **IIIT Bhopal** Building with **React, Next.js, Node.js, Express, MongoDB & React Native**. Currently exporing **scalable backend systems** — authentication, caching, and payment infrastructure. Consistently practicing **Data Structures & Algorithms** consistently on LeetCode while preparing for **Software Engineering** roles and internships<br>
