# 💫 About Me:
Final-year **Information Technology** student at **IIIT Bhopal**, building with **React, Next.js, Node.js, Express, MongoDB & React Native**. Currently exploring **scalable backend systems** — authentication, caching, and payment infrastructure. Consistently practicing **Data Structures & Algorithms** on LeetCode while preparing for **Software Engineering** roles and internships.<br>
...
**🍁 MacroZone**
Cross-platform mobile app for tracking meals, calories, and daily macronutrients, with a clean, intuitive UX built for fast daily logging.
`React Native` `Expo`
