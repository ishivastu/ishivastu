...
A real-time chat app with user authentication, one-to-one messaging, and profile management.
Features include JWT authentication, secure password hashing using bcrypt, and image uploads using Multer + Cloudinary.
...
- Email: shivastumishra@gmail.com
